...
\begin{itemize}
\item PCs de desenvolupament: Evidentment tenir ordinadors on poder desenvolupar i provar el codi és molt important, en aquest cas se n'han fet servir dos de diferents. Un a la FIB i un altre a casa. En tots els casos és important poder disposar de diferents màquines on fer les proves per veure que el funcionament és correcte a totes elles, però en el cas d'una aplicació 3D es una mica més important, ja que el comportament de les tarjetes 3D varia de xip a xip. El PC de la FIB té les següents característiques\newline
\begin{tabular}{|c|c|} \hline 
Processador &  \\ \hline 
Memòria &  \\ \hline 
Disc Dur &  \\ \hline 
Targeta gràfica &  \\ \hline 
\end{tabular}\newline
mentre que el PC de casa té aquestes\newline
\begin{tabular}{|c|c|} \hline 
Processador & AMD Athlon XP 1600+ \\ \hline 
Memòria & 376 MB \\ \hline 
Disc Dur & 160 GB \\  \hline 
Targeta gràfica & Xip Kyro 2 de PowerVR \\ \hline 
\end{tabular}\newline
