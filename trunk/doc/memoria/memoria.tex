...
No se li pot fer split a un triangle si el triangle amb el qual comparteix la base no es del mateix nivell, per exmeple el triangle B de la figura \ref{fig: triangleBase}, en aquest cas si realment volem partir-lo hem de fer abans un split del triangle amb el que comparteix la base. La figura \ref{fig: forceSplitExtrem} és un cas extrem en el que caldria fer 4 splits forçats abans de fer la partició del triangle $T$.
