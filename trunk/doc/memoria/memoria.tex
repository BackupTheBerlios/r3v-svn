...
\item \textit{Introducció} - MODIFICAAAAAAAAAAAAAAR Aquesta part de la memòria és aquella part que algú que ja tingués coneixements sobre gràfics, interfícies gràfiques, l'algorisme ROAM, etc. podria saltar-se, es a dir, és la secció que explica els conceptes per entendre tot allò que s'utilitzarà en la realització del projecte.
